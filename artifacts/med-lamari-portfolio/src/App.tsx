...
const copy = {
  en: {
    ...
    heroSubtitle: 'I build modular web applications and microservices across Java, PHP, Node.js and Angular — with 2.5 years of professional delivery experience.',
    ...
    stats: [['2.5', 'years professional experience'], ['05', 'professional roles'], ['16+', 'technologies listed'], ['03', 'certifications']],
  ...
  fr: {
    ...
    stats: [['2,5', 'ans d’expérience professionnelle'], ['05', 'expériences professionnelles'], ['16+', 'technologies listées'], ['03', 'certifications']],
